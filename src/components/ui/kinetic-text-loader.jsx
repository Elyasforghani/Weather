  ...
  return (
    <div
      ...
      <div className="relative scale-75 md:scale-90 lg:scale-100">
        {/* The moving dot */}
        <div
          className="absolute z-10 top-[40px] left-[85px] w-[6px] h-[6px] bg-white  dark:bg-neutral-200 rounded-full"
          style={{ animation: "ktl-dotMove 1800ms cubic-bezier(0.25,0.25,0.75,0.75) infinite" }} />
        
        <p
          className="relative m-0 whitespace-nowrap text-[3.75rem] mt-3.5 text-white dark:text-neutral-200"
          aria-label={text}>
